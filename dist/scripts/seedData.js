...
function seedData() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const category1 = yield prisma.category.upsert({
                where: { id: "cat_001" },
                update: {},
                create: {
                    id: "cat_001",
            ...
            const category2 = yield prisma.category.upsert({
                where: { id: "cat_002" },
                update: {},
                create: {
                    id: "cat_002",
            ...
            const service1 = yield prisma.services.upsert({
                where: { id: "srv_001" },
                update: {},
                create: {
                    id: "srv_001",
            ...
            const service2 = yield prisma.services.upsert({
                where: { id: "srv_002" },
                update: {},
                create: {
                    id: "srv_002",
